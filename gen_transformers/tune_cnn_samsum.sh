...
SHARED="--max_epochs ${MAX_EPOCH} --max_brio_candidates ${MAX_BRIO_CANDS} --save_top_k 0 --dataset cnn_dailymail --lr ${LR} --gpu_device ${DEVICE} --hf_model facebook/bart-large-cnn --pretrained_path $FT_PATH -add_brio_loss --extract_method generate --val_metric_mode max --val_monitor_metric extract_mean_f1 --copy_bart_class_dropout 0.1"

CWS=(0.1 0.5 1.0 5.0 10.0)
MWS=(0.1 0.5 1.0)
LPS=(0.0 0.5 1.0 2.0 4.0)
